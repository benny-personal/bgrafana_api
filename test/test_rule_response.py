...
from bgrafana_api.models.rule_response import RuleResponse  # noqa: E501
...
class TestRuleResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RuleResponse:
        ...
        if include_optional:
            return RuleResponse(
                data = bgrafana_api.models.rule_discovery.RuleDiscovery(
                    groups = [
                        bgrafana_api.models.rule_group.RuleGroup(
                            ...
                            name = '', 
                            rules = [
                                bgrafana_api.models.alerting_rule.AlertingRule(
                                    alerts = [
