...
from bgrafana_api.models.postable_user_config import PostableUserConfig  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PostableUserConfig:
        ...
        if include_optional:
            return PostableUserConfig(
                alertmanager_config = bgrafana_api.models.postable_api_alerting_config.PostableApiAlertingConfig(
                    global = bgrafana_api.models.global_config.GlobalConfig(
                    ...
                    receivers = [
                        bgrafana_api.models.postable_api_receiver.PostableApiReceiver(
                            discord_configs = [
                            ...
                            grafana_managed_receiver_configs = [
                                bgrafana_api.models.postable_grafana_receiver.PostableGrafanaReceiver(
