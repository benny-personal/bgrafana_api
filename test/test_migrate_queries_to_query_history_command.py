...
from bgrafana_api.models.migrate_queries_to_query_history_command import MigrateQueriesToQueryHistoryCommand  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MigrateQueriesToQueryHistoryCommand:
        ...
        if include_optional:
            return MigrateQueriesToQueryHistoryCommand(
                queries = [
                    bgrafana_api.models.query_to_migrate.QueryToMigrate(
                        comment = '', 
                        created_at = 56, 
                        datasource_uid = '', 
