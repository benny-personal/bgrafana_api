...
from bgrafana_api.models.extended_receiver import ExtendedReceiver  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ExtendedReceiver:
        ...
        if include_optional:
            return ExtendedReceiver(
                email_configs = bgrafana_api.models.email_config_configures_notifications_via_mail/.EmailConfig configures notifications via mail.(
                    auth_identity = '', 
                    auth_password = '', 
                    auth_password_file = '', 
                    auth_secret = '', 
                    ...
                    tls_config = bgrafana_api.models.tls_config_configures_the_options_for_tls_connections/.TLSConfig configures the options for TLS connections.(
                        ...
                        server_name = '', ), 
                    to = '', ),
                grafana_managed_receiver = bgrafana_api.models.postable_grafana_receiver.PostableGrafanaReceiver(
                    ...
                    type = '', 
                    uid = '', ),
                opsgenie_configs = bgrafana_api.models.ops_genie_config_configures_notifications_via_ops_genie/.OpsGenieConfig configures notifications via OpsGenie.(
                    actions = '', 
                    api_key = '', 
                    api_key_file = '', 
                    ...
                    tags = '', 
                    update_alerts = True, ),
                pagerduty_configs = bgrafana_api.models.pagerduty_config_configures_notifications_via_pager_duty/.PagerdutyConfig configures notifications via PagerDuty.(
                    class = '', 
                    client = '', 
                    client_url = '', 
                    component = '', 
                    ...
                    source = '', 
                    url = , ),
                pushover_configs = bgrafana_api.models.pushover_config.PushoverConfig(
                    expire = '', 
                    html = True, 
                    http_config = bgrafana_api.models.http_client_config_configures_an_http_client/.HTTPClientConfig configures an HTTP client.(
                        authorization = bgrafana_api.models.authorization_contains_http_authorization_credentials/.Authorization contains HTTP authorization credentials.(
                    ...
                    user_key = '', 
                    user_key_file = '', ),
                slack_configs = bgrafana_api.models.slack_config_configures_notifications_via_slack/.SlackConfig configures notifications via Slack.(
                    actions = [
                    ...
                    title_link = '', 
                    username = '', ),
                victorops_configs = bgrafana_api.models.victor_ops_config_configures_notifications_via_victor_ops/.VictorOpsConfig configures notifications via VictorOps.(
                    api_key = '', 
                    api_key_file = '', 
                    api_url = bgrafana_api.models.a_url_represents_a_parsed_url_(technically,_a_uri_reference)/.A URL represents a parsed URL (technically, a URI reference).(
                        force_query = True, 
                    ...
                    send_resolved = True, 
                    state_message = '', ),
                webhook_configs = bgrafana_api.models.webhook_config_configures_notifications_via_a_generic_webhook/.WebhookConfig configures notifications via a generic webhook.(
                    http_config = bgrafana_api.models.http_client_config_configures_an_http_client/.HTTPClientConfig configures an HTTP client.(
                        authorization = bgrafana_api.models.authorization_contains_http_authorization_credentials/.Authorization contains HTTP authorization credentials.(
                            credentials = '', 
                            credentials_file = '', 
                    ...
                    send_resolved = True, 
                    url = , ),
                wechat_configs = bgrafana_api.models.wechat_config_configures_notifications_via_wechat/.WechatConfig configures notifications via Wechat.(
                    agent_id = '', 
                    api_secret = '', 
                    api_url = bgrafana_api.models.a_url_represents_a_parsed_url_(technically,_a_uri_reference)/.A URL represents a parsed URL (technically, a URI reference).(
                        force_query = True, 
