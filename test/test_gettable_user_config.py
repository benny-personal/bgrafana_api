...
from bgrafana_api.models.gettable_user_config import GettableUserConfig  # noqa: E501
    ...
    def make_instance(self, include_optional) -> GettableUserConfig:
        ...
        if include_optional:
            return GettableUserConfig(
                alertmanager_config = bgrafana_api.models.gettable_api_alerting_config.GettableApiAlertingConfig(
