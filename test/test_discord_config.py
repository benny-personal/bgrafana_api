...
from bgrafana_api.models.discord_config import DiscordConfig  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DiscordConfig:
        ...
        if include_optional:
            return DiscordConfig(
                ...
                send_resolved = True,
                title = '',
                webhook_url = bgrafana_api.models.a_url_represents_a_parsed_url_(technically,_a_uri_reference)/.A URL represents a parsed URL (technically, a URI reference).(
                    force_query = True, 
                    fragment = '', 
                    host = '', 
                    omit_host = True, 
